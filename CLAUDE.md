This is a project to build an app to extend the built-in functionality of a BigCommerce B2B Edition store.

The app uses Bun as a package manager and runtime. Default to using Bun instead of Node.js.
